...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="6.79";//插件版本号
	public static final String PLUGIN_NAME="qqrob.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.qq";//插件名字；
